        ...
        function MoneyMaskDirective($locale, $parse, PreFormatters) {
            return {
                ...
                link: function (scope, element, attrs, ctrl) {
                    ...
                    // PERSONALIZAÇÃO DA DIRETIVA
                    var decimalDelimiter = ',',
                       thousandsDelimiter = '.',
                       currencySym = attrs.currencySym,
                       symbolSeparation = ' ',
                       decimals = $parse(attrs.uiMoneyMask)(scope);
            ...
            return {
                ...
                link: function (scope, element, attrs, ctrl) {
                    var decimalDelimiter = $locale.NUMBER_FORMATS.DECIMAL_SEP,
                        ...
                        clearWhenInvalid = angular.isDefined(attrs.clearWhenInvalid);
                    ...
                    function parser(value) {
                        ...
                        var valueToFormat = PreFormatters.clearDelimitersAndLeadingZeros(value) || (clearWhenInvalid ? '' : '0');
